...
namespace SETextToSpeechMod
{
    public static class PrettyScaryDictionary
    {
        ...
        */        
        ...
        {
            {"_A_", row}, { "ALL", new string[]{ AWW, " ", LIH } }, { "ALSO", new string[]{ AWW, LIH, SIH, OWE } }, { "AUTOMATIC", new string[]{ AWW, TIH, " ", OWE, MIH, AHH, TIH, IHH, KIH, } },
            ...
            {"_S_", row}, { "SIR", new string[]{ SIH, RIH, "", } }, { "SCIENCE", new string[]{ SIH, EYE, " ", EHH, NIH, SIH, "", } }, { "SHE", new string[]{ SIH, HIH, EEE, } }, { "SHOULD", new string[]{ SIH, HIH, " ", OOO, DIH, "", } }, { "SMALL", new string[]{ SIH, MIH, AWW, LIH, "", } }, { "SOLUTION", new string[]{ SIH, HOH, LIH, OOO, SIH, HIH, UHH, NIH,} },
