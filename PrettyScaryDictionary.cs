...
namespace SETextToSpeechMod
{
    public static class PrettyScaryDictionary
    {
        ...
        */        
        ...
        {
            {"_A_", row}, { "ALL", new string[]{ AWW, " ", LIH } }, { "A", new string[]{ UHH } }, { "ALSO", new string[]{ AWW, LIH, SIH, OWE } }, { "AUTOMATIC", new string[]{ AWW, TIH, " ", OWE, MIH, AHH, TIH, IHH, KIH, } },
            {"_B_", row}, { "BEFORE", new string[]{ BIH, EEE, FIH, AWW, RIH, "", } },
            {"_C_", row}, { "COULD", new string[]{ KIH, UHH, " ", DIH, "", } }, { "CHINESE", new string[]{ KIH, HIH, EYE, NIH, EEE, " ", ZIH, } },
            ...
            {"_G_", row}, { "GO", new string[]{ GIH, OWE, } }, { "GOOD", new string[]{ GIH, OOO, "", DIH, } }, { "GIANT", new string[]{ JIH, EYE, IHH, NIH, TIH, } }, { "GET", new string[]{ GIH, EHH, TIH, } },
            {"_H_", row}, { "HELL", new string[]{ HIH, EHH, LIH, "", } }, { "HEY", new string[]{ HIH, AEE, "", } }, { "HARDWARE", new string[]{ HIH, UHH, RIH, DIH, " ", WIH, EHH, RIH } },
            {"_I_", row}, { "IM", new string[]{ EYE, MIH, } }, { "ILL", new string[]{ EYE, LIH, "", } }, { "INFINITE", new string[]{ IHH, NIH, " ", FIH, IHH, NIH, IHH, TIH, } }, { "INTEREST", new string[]{ IHH, NIH, TIH, RIH, " ", EHH, SIH, TIH, } },
            {"_J_", row},
            {"_K_", row},
            ...
            {"_M_", row}, { "MADDEN", new string[]{ MIH, AHH, DIH, EHH, NIH, "", } }, { "MEME", new string[]{ MIH, EEE, " ", MIH, } }, { "MANUAL", new string[]{ MIH, AHH, NIH, WIH, EHH, LIH, } },
            {"_N_", row}, { "NIGHT", new string[]{ NIH, EYE, " ", TIH, "", } }, { "NIGGA", new string[]{ NIH, IHH, GIH, UHH, "", } }, { "NURSERY", new string[]{ NIH, RIH, " ", SIH, UHH, RIH, EEE, } }, { "NOW", new string[]{ NIH, OWE, WIH, } },
            ...
            {"_S_", row}, { "SIR", new string[]{ SIH, RIH, "", } }, { "SCIENCE", new string[]{ SIH, EYE, " ", EHH, NIH, SIH, "", } }, { "SHE", new string[]{ SIH, HIH, EEE, } }, { "SHOULD", new string[]{ SIH, HIH, " ", UHH, DIH, "", } }, { "SMALL", new string[]{ SIH, MIH, AWW, LIH, "", } }, { "SOLUTION", new string[]{ SIH, HOH, LIH, OOO, SIH, HIH, UHH, NIH,} },
            ...
            {"_W_", row}, { "WOULD", new string[]{ WIH, OOO, " ", DIH, "", } },
            {"_X_", row},
            {"_Y_", row},
            {"_Z_", row},
        };
